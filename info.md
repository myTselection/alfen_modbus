...
<img style="border: 5px solid #767676;border-radius: 10px;max-width: 350px;width: 100%;box-sizing: border-box;" src="https://github.com/ThaStealth/alfen_modbus/blob/master/demo.png?raw=true" alt="Demo">
